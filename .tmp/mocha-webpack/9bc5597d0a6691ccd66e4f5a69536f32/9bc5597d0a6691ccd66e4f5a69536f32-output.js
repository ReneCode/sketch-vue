...
var assertion = __webpack_require__(81);
...
var expect = __webpack_require__(84);
exports.use(expect);
...
var should = __webpack_require__(85);
exports.use(should);
...
var Point = function () {
  ...
  (0, _createClass3.default)(Point, [{
    ...
    key: "equal",
    value: function equal(otherPoint) {
...
var getName = __webpack_require__(68);
...
var ItemBase = function ItemBase(id) {
  (0, _classCallCheck3.default)(this, ItemBase);
...
var map = {
	"./item-polygon.test.js": 73,
	"./item-rectangle.test.js": 74
};
...
var testsContext = __webpack_require__(69);
...
var _itemBase = __webpack_require__(44);
...
var ItemPolygon = function (_ItemBase) {
  (0, _inherits3.default)(ItemPolygon, _ItemBase);

  function ItemPolygon() {
    (0, _classCallCheck3.default)(this, ItemPolygon);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ItemPolygon.__proto__ || (0, _getPrototypeOf2.default)(ItemPolygon)).call(this, 0));
  ...
  (0, _createClass3.default)(ItemPolygon, [{
    key: 'clone',
    value: function clone() {
      var newPolygon = new ItemPolygon();
      var clone = JSON.parse((0, _stringify2.default)(this));
      (0, _assign2.default)(newPolygon, clone);
      return newPolygon;
    }
  }, {
    key: 'addPoint',
    ...
    key: 'updateLastPoint',
    value: function updateLastPoint(pt) {
      var cnt = this.svg.points.length;
      if (cnt === 0) {
    ...
    key: 'createFromSvg',
    value: function createFromSvg(svg) {
      var polygon = new ItemPolygon();
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = (0, _getIterator3.default)(svg.points), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var pt = _step.value;

          polygon.addPoint(new _point2.default(pt.x, pt.y));
        }
      } catch (err) {
...
var ItemRectangle = function (_ItemBase) {
  (0, _inherits3.default)(ItemRectangle, _ItemBase);

  function ItemRectangle(pt1, pt2) {
    (0, _classCallCheck3.default)(this, ItemRectangle);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ItemRectangle.__proto__ || (0, _getPrototypeOf2.default)(ItemRectangle)).call(this, 0));

    pt1 = pt1 || new _point2.default();
    pt2 = pt2 || new _point2.default();
    var delta = pt1.sub(pt2).abs();
    var svg = {
      type: 'rect',
  ...
  (0, _createClass3.default)(ItemRectangle, [{
    key: 'clone',
    value: function clone() {
      var newRectangle = new ItemRectangle();
      var clone = JSON.parse((0, _stringify2.default)(this));
      (0, _assign2.default)(newRectangle, clone);
      return newRectangle;
    }
  }, {
    key: 'setFromTwoPoints',
    value: function setFromTwoPoints(pt1, pt2) {
      var delta = pt1.sub(pt2).abs();
    ...
    key: 'createFromSvg',
    value: function createFromSvg(svg) {
      var rectangle = new ItemRectangle();
      (0, _assign2.default)(rectangle.svg, svg);
      return rectangle;
    }
  }]);
...
var _itemPolygon = __webpack_require__(71);

var _itemPolygon2 = _interopRequireDefault(_itemPolygon);
...
var should = __webpack_require__(51).should();

describe('ItemPolygon', function () {
  it('should construct ItemPolygon()', function () {
    var item = new _itemPolygon2.default();
    item.svg.type.should.be.equal('polygon');
    (item instanceof _itemPolygon2.default).should.be.true;
  });

  it('should addPoint to ItemPolygon()', function () {
    var item = new _itemPolygon2.default();
    var pt = new _point2.default(50, 100);
    item.addPoint(pt);
    item.svg.points.length.should.be.equal(1);
    (item.svg.points[0] instanceof _point2.default).should.be.true;
...
var _itemRectangle = __webpack_require__(72);

var _itemRectangle2 = _interopRequireDefault(_itemRectangle);
...
describe('ItemRectangle', function () {
  it('should construct ItemRectangle()', function () {
    var item = new _itemRectangle2.default();
    item.svg.type.should.be.equal('rect');
    ...
    (item instanceof _itemRectangle2.default).should.be.true;
  });

  it('should construct ItemRectangle(p1,p2)', function () {
    var p1 = new _point2.default(50, 100);
    var p2 = new _point2.default(150, 300);
    var item = new _itemRectangle2.default(p1, p2);
    item.svg.type.should.be.equal('rect');
    item.svg.x.should.be.equal(50);
    item.svg.y.should.be.equal(100);
    item.svg.width.should.be.equal(100);
  ...
  it('should clone ItemRectangle', function () {
    var p1 = new _point2.default(50, 100);
    var p2 = new _point2.default(150, 300);
    var org = new _itemRectangle2.default(p1, p2);
    var item = org.clone();
    item.svg.type.should.be.equal('rect');
    item.svg.x.should.be.equal(50);
    item.svg.y.should.be.equal(100);
  ...
  it('should move() ItemRectangle', function () {
    var p1 = new _point2.default(50, 100);
    var p2 = new _point2.default(150, 300);
    var item = new _itemRectangle2.default(p1, p2);
    var delta = new _point2.default(10, 20);
    item.move(delta);
    item.svg.x.should.be.equal(60);
    item.svg.y.should.be.equal(120);
  });

  it('move() should not modify orginal ItemRectangle', function () {
    var p1 = new _point2.default(50, 100);
    var p2 = new _point2.default(150, 300);
    var org = new _itemRectangle2.default(p1, p2);
    var item = org.clone();
...
var addLengthGuard = __webpack_require__(19);
...
var flag = __webpack_require__(1)
  , getActual = __webpack_require__(52)
  , inspect = __webpack_require__(20)
  , objDisplay = __webpack_require__(55);
...
var getOwnEnumerablePropertySymbols = __webpack_require__(53);
...
var pathval = __webpack_require__(142);

/*!
 * test utility
 */

exports.test = __webpack_require__(99);

/*!
 * type utility
 */

exports.type = __webpack_require__(42);

/*!
 * expectTypes utility
 */
exports.expectTypes = __webpack_require__(90);

/*!
 * message utility
 */

exports.getMessage = __webpack_require__(92);

/*!
 * actual utility
 */

exports.getActual = __webpack_require__(52);
...
exports.objDisplay = __webpack_require__(55);
...
exports.eql = __webpack_require__(141);
...
exports.getName = __webpack_require__(68);

/*!
 * add Property
 */

exports.addProperty = __webpack_require__(88);
...
exports.overwriteProperty = __webpack_require__(98);

/*!
 * overwrite Method
 */

exports.overwriteMethod = __webpack_require__(97);

/*!
 * Add a chainable method
 */

exports.addChainableMethod = __webpack_require__(86);
...
exports.compareByInspect = __webpack_require__(89);

/*!
 * Get own enumerable property symbols method
 */

exports.getOwnEnumerablePropertySymbols = __webpack_require__(53);

/*!
 * Get own enumerable properties method
 */

exports.getOwnEnumerableProperties = __webpack_require__(93);

/*!
 * Checks error against a given set of criteria
 */

exports.checkError = __webpack_require__(100);
...
exports.addLengthGuard = __webpack_require__(19);
...
exports.isNaN = __webpack_require__(95);
...
var keyOf = __webpack_require__(119);
